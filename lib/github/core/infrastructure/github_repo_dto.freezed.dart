...
//all the filed are according to the key only count is not os use jsonKey
  ...
  String get name =>
      throw _privateConstructorUsedError; //everything in json annotation constructor needs to be constant
//
...
abstract class _GithubRepoDTO extends GithubRepoDTO {
  ...
  @override //all the filed are according to the key only count is not os use jsonKey
  UserDTO get owner => throw _privateConstructorUsedError;
  @override
  String get name => throw _privateConstructorUsedError;
  @override //everything in json annotation constructor needs to be constant
//
  @JsonKey(fromJson: _descriptionFromJson)
  String get description => throw _privateConstructorUsedError;
  @override
