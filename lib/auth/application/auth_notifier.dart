// freezed union for multiple case , as this is going t be asynchronous
//like it have different states loading,loaded, etc
...
class AuthState with _$AuthState {
  ...
  //we are going to use the either type inside not in auth state
  const factory AuthState.failure(AuthFailure failure) = _Failure;
}

typedef AuthUriCallback = Future<Uri> Function(Uri authorizationUrl);

//think first about states , then notifiers
